...
client.on(Events.InteractionCreate, async interaction => {
    ...
    if (interaction.isButton()) {
        if (interaction.customId === 'finalize_ticket') {
            ...
            if (!isStaff) {
                return interaction.reply({ content: 'Apenas membros da staff podem finalizar tickets.', ephemeral: true });
            }
        ...
        if (interaction.customId === 'assume_ticket') {
            ...
            await interaction.reply({ content: `✅ ${interaction.user} assumiu o ticket!`, ephemeral: false });
        }
        ...
        if (interaction.customId === 'staff_panel') {
            ...
            if (!isStaff) {
                return interaction.reply({ content: 'Apenas membros da staff podem acessar o painel.', ephemeral: true });
            }

            await interaction.reply({ content: 'Painel Staff - Em desenvolvimento', ephemeral: true });
        }
