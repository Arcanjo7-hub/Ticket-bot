...
client.on(Events.InteractionCreate, async interaction => {
    ...
    if (interaction.isStringSelectMenu() && interaction.customId === 'menu_deletar_produto') {
        ...
        const embed = new EmbedBuilder()
            ...
            .setFooter({ text: "Clique em um botão abaixo", iconURL: client.user.avatarURL() });
    ...
    if (interaction.isButton() && interaction.customId.startsWith('confirmar_deletar_')) {
        ...
        const embed = new EmbedBuilder()
            ...
            .setColor(COLORS.success)
            .setFooter({ text: "Produto deletado do catálogo", iconURL: client.user.avatarURL() });
    ...
    if (interaction.isStringSelectMenu() && interaction.customId === "ticket") {
        ...
        const welcomeEmbed = new EmbedBuilder()
            ...
            .setDescription("Bem-vindo ao canal oficial de suporte da Arcanjo Store\n\n⏰ HORÁRIO DE ATENDIMENTO: 12:00 às 23:00\n\n⚠️ Suportes fora deste horário serão respondidos no próximo período\n\n🚪 Use o botão abaixo para sair do atendimento")
            .setColor(COLORS.accent)
            .setThumbnail(TICKET_IMAGE_URL)
            .setFooter({ text: "Obrigado por entrar em contato!", iconURL: client.user.avatarURL() });
        ...
        const successEmbed = new EmbedBuilder()
            ...
            .setColor(COLORS.success)
            .setFooter({ text: "Obrigado por sua paciência!", iconURL: client.user.avatarURL() })
            .setTimestamp();
    ...
    if (interaction.isStringSelectMenu() && interaction.customId === "loja_produtos") {
        ...
        const addEmbed = new EmbedBuilder()
            ...
            .setColor(COLORS.accent)
            .setFooter({ text: "Produto adicionado com sucesso!", iconURL: client.user.avatarURL() })
            .setTimestamp();
    ...
    if (interaction.isButton()) {
        ...
        if (interaction.customId === 'ver_carrinho') {
            ...
            const carrinhoEmbed = new EmbedBuilder()
                ...
                .setDescription(descricao)
                .setColor(COLORS.accent)
                .setFooter({ text: `${carrinho.produtos.length} item(ns)`, iconURL: client.user.avatarURL() })
                .setTimestamp();
        ...
        if (interaction.customId === 'pagar_carrinho') {
            ...
            const pixEmbed = new EmbedBuilder()
                ...
                .setFooter({ text: "Após realizar o pagamento, clique em confirmar", iconURL: client.user.avatarURL() })
                .setTimestamp();
        ...
        if (interaction.customId === 'confirmar_pagamento') {
            ...
            const confirmEmbed = new EmbedBuilder()
                ...
                .setColor(COLORS.success)
                .setFooter({ text: "Obrigado por sua compra!", iconURL: client.user.avatarURL() })
                .setTimestamp();
